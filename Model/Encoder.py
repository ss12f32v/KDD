...
class VanillaEncoder(nn.Module):
    ...
    def __init__(self, hidden_size, output_size):
        ...
        self.dayofyear_embedding = nn.Embedding(365, embedding_size)
    ...
    def forward(self, input_seqs, hidden=None):
        ...
        input_seqs = torch.cat((input_seqs[:, :, 0:6],one_hot_total_embedding), dim= 2)
